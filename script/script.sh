CUDA_VISIBLE_DEVICE=0 nohup python comprehensive_evaluation/analyzer.py  >log/analysis_assert_error_BTCT.log 2>&1 &

CUDA_VISIBLE_DEVICE=1 nohup python comprehensive_evaluation/analyzer.py \
...
CUDA_VISIBLE_DEVICE=2 nohup python comprehensive_evaluation/analyzer.py \
...
CUDA_VISIBLE_DEVICE=3 nohup python comprehensive_evaluation/analyzer.py \
